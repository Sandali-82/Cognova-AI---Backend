...
apps/
├── documents/ # Document upload, PDF text extraction
├── summarization/ # AI summarization
├── quizzes/ # Quiz generation, submission, scoring
├── rag_chat/ # RAG-based chat (pgvector)
└── analytics/ # Score analytics and subject performance
